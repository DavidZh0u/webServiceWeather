...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements mywebServices.WeatherWebService {
 ...
 */
    ...
    public mywebServices.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public mywebServices.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mywebServices.WeatherWebServiceSoap12Stub _stub = new mywebServices.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public mywebServices.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public mywebServices.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mywebServices.WeatherWebServiceSoap_BindingStub _stub = new mywebServices.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mywebServices.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mywebServices.WeatherWebServiceSoap12Stub _stub = new mywebServices.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (mywebServices.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mywebServices.WeatherWebServiceSoap_BindingStub _stub = new mywebServices.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
